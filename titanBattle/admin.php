...
function contactCheck()
{
    ...
    if (empty($error) && $_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        require '../common/data/mailvars.php'; 

        //メール本文の組み立て
        $mail_body = 'タイタンシミュレータページからのお問い合わせ' . "\n\n";
        ...
        $mail_body = 'れおまるタイタンシミュレータにお問い合わせを送信しました。' . "\n";
        ...
        if ( ini_get( 'safe_mode' ) ) {
            //セーフモードがOnの場合は第5引数が使えない
            $result = mb_send_mail( $email, '【確認】タイタンシミュレータへのお問い合わせ', $mail_body, $header );
        } else {
            $result = mb_send_mail( $email, '【確認】タイタンシミュレータへのお問い合わせ', $mail_body, $header, '-f' . $returnMail );
        }
    ...
    <div class="content-box">
        <div id="content">
            ...
            <div id="loginArea">
                ...
                <div id="loginExplain">
                    ご利用パスワードは<a href="https://youtu.be/3BzntBkdf7c">こちらのYouTube動画</a>内にて案内しております。
                </div>
                <div id="contactForm">

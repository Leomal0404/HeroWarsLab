function copyToEnemy(){
    myData["enemy_titan"] = JSON.parse(JSON.stringify(myData["own_titan"]));
    storageUpdate();
...
function copyToOwn(){
    myData["own_titan"] = JSON.parse(JSON.stringify(myData["enemy_titan"]));
    storageUpdate();
...
function exportData(){
    ...
    // 暗号化
    var PlainText = JSON.stringify(myData["own_titan"]);
